    ...
    <div class="main10inter">
        <table width="670" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td><input type="text" class="cname3" id='starttime'
                           onblur="js:if(document.getElementById('endtime').value == ''){document.getElementById('endtime').value = this.value;}">
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td height="48" width="99"><span class="fontsize1">Timezone</span><span><img src="./images/bg_100.png"/></span>
                </td>
                <td>&nbsp;</td>
                <td><select id='timezone' class="cname4">
                        <?php
                        $timezone_str = "";
            ...
            <tr>
                <td height="48"><span class="fontsize1">Alert</span><span><img src="./images/bg_100.png"/></td>
                <td>&nbsp;</td>
                <td colspan="2">
                    <form id="form2" name="form2" method="post" action="">
                        <label>
                            <select name="alert"  class="cname4" id="alert">
                                <?php
                                $alert_str = "";
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="43%" align="right">
                                <label>
                                    <input type="submit" name="Submit" value="" onclick='submitSchedule()'
                                           class="cname5">
                                </label>
                            </td>
                            <td width="6%">&nbsp;</td>
                            <td width="51%">
                                <label>
                                    <input type="button" class="cname6"
                                           onclick="js:location.href='<?php echo Yii::app()->createUrl('Schedule/admin'); ?>'">
                                </label>
                            </td>
                        </tr>
                    </table>
...
<script language='javascript'>
        ...
        <?php
            echo CHtml::ajax(
                array(
                    ...
                    "data" => "js:{activity:activity,start:start,end:end,desp:desp,onduty:onduty,timezone:timezone,alert:alert}",
                    "type"=>"POST",
    ...
    function selectActivity(choose) {
        ...
        // update timezone according to activity
