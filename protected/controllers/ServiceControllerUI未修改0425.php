...
// </li>";
  ...
  <tr>
    ...
    <td width='154' height='33' id='name_".$membersvals->memberid."'>".$membersvals->membername."</td>
    <td width='222' id='email_".$membersvals->memberid."'>".$membersvals->memberemail."</td>
    <td width='116'><select  id=".$membersvals->memberid." name = 'selectdMembers' onchange=\"changerole('".$membersvals->memberid."')\"><option value='-1'>No share</option><option value ='2' ".(($sharedMembers[$membersvals->memberid] == 2)?'selected':'').">Participant</option></select></td>
  </tr>
</table>
</li>";
...
// </li>";
  ...
  <tr>
    ...
    <td width='154' height='33' id='name_".$membersvals->memberid."'>".$membersvals->membername."</td>
    <td width='222' id='email_".$membersvals->memberid."'>".$membersvals->memberemail."</td>
    <td width='116'><select  id=".$membersvals->memberid." name = 'selectdMembers' onchange=\"changerole('".$membersvals->memberid."')\"><option value='-1'>No share</option><option value ='2'>Participant</option></select></td>
  </tr>
</table>
</li>";
							}else{
					...
					if(!in_array($memberid,$shared)){
						...
						if($result['code'] == 200){
							...
							if($cache === array() || $cache){
								...
								$addsharedmember->mobilenumber = 0;
