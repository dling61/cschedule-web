...
<div class="main9three" id="createfromemail" style="display:none">
  ...
  <tr>
	...
	<tr>
        <td colspan="3" class="font1">For a Gmail account, please first follow the instructions described in <a target="_blank" href="https://support.google.com/mail/answer/14257?p=client_login&rd=1" style="color:red">the following link</a>, then come to this page to import contacts.</td>
      </tr>
