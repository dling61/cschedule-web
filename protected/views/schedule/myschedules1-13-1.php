...
if($member){
	foreach($member as $memberkey=>$membervals){
		$filter_participant_str .= "<option name='participantfilter' value='".$memberkey."' ".(isset($participantselected)?(($participantselected == $memberkey)?'selected':''):'').">".$membervals."</option>";
	}
}
?>
